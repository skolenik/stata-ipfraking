...
Listed below is the full syntax of \stcmd{ipfraking}, with the minimal description of options, 
...
\begin{enumerate}
    ...
    \item Raking is performed at the household level by using \stcmd{if household\_head==1}
